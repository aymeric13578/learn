...
class RecommendationServiceApplicationTests {
	...
	@Test
	void getRecommendationsByCourseId() {

		int courseId = 1;

		client.get()
				.uri("/recommendation?courseId=" + courseId)
	...
	void getRecommendationsInvalidParameter() {
		...
		client.get()
				.uri("/recommendation?courseId=no-integer")
				.accept(APPLICATION_JSON)
				.exchange()
				.expectStatus().isEqualTo(BAD_REQUEST)
				.expectHeader().contentType(APPLICATION_JSON)
	...
	void getRecommendationsNotFound() {
		...
		int courseIdNotFound = 113;

		client.get()
				.uri("/recommendation?courseId=" + courseIdNotFound)
				.accept(APPLICATION_JSON)
				.exchange()
				.expectStatus().isOk()
				.expectHeader().contentType(APPLICATION_JSON)
	...
	void getRecommendationsInvalidParameterNegativeValue() {
		...
		client.get()
				.uri("/recommendation?courseId=" + courseIdInvalid)
				.accept(APPLICATION_JSON)
				.exchange()
